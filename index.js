...
// 🕛 يصفّر سحبات الأسلحة لجميع اللاعبين — يشتغل تلقائياً كل يوم الساعة 12:00 ص بتوقيت السعودية
function scheduleWeaponPullsReset() {
    ...
    global.weaponResetInterval = setInterval(async () => {
        ...
        try {
            ...
            if (hour === 0 && minute === 0) {
                ...
                console.log('✅ تم تصفير سحبات الأسلحة لجميع اللاعبين (12:00 ص بتوقيت السعودية)')
            }
