...
'.اختيار',
    ...
    // كان بالأسفل وسط آلاف الأسطر، فكان يمر أولاً على:
    // player upsert بقاعدة البيانات + فحص فعالية القلوب +
    // anime events + بناء قائمة شرح الأوامر + آلاف مقارنات
    // النصوص الأخرى — كل هذا كان يأخر إرسال الصورة.
    // هنا يرد فوراً بدون أي انتظار غير ضروري.
    // =========================
