...
const commandExplanations = {
    ...
    'الدومين_التعاوني': {
        ...
        '.ايكو': 'يعرض حقيبة الإيكوز عندك مرقّمة (مطوّرة وغير مطوّرة) عشان تلبسها لاحقاً.',
        ...
        '.ازالة': 'يخلع قطعة إيكو من شخصية عن طريق الكوست. مثال: .ازالة رقم_الشخصية الكوست',
...
📊 ${result.item.mainStat.type} +${result.item.mainStat.value}`
    ...
    if (text.startsWith('.ازالة')) {
        ...
        const subSlot = args[3] ? Number(args[3]) : 1
