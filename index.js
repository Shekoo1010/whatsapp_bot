...
if (text === '.ترتيب') {
    ...
    try {
        ...
        const before =
            player.characters.map(c => c._id?.toString() || c.name)
        ...
        return safeSend(
            ...
            {
                text: changed
                    ? '✅ تم ترتيب شخصياتك تلقائياً حسب الرتبة ثم القوة (⚔️).\n💡 اكتب .شخصياتي لمشاهدة الترتيب الجديد.'
                    : '✅ شخصياتك مرتبة بالفعل، ماكو تغيير.'
            }
        )
