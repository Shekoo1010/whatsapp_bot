...
const commandExplanations = {
    ...
    'الدومين_التعاوني': {
        ...
        '.تطوير_ايكو': 'يرفع لفل قطعة إيكو من حقيبتك مقابل تيونر الصدى (1 تيونر = لفل واحد) + 400,000 مال لكل لفل، ويفتح لك ساب ستات جديد عند لفل 5/10/15. مثال: .تطوير_ايكو 1 أو .تطوير_ايكو 1 5',
...
(رقم القطعة من .ايكو — 1 تيونر = لفل واحد + 400,000 مال لكل لفل)`
            })
...
💡 اكسب تيونرات عن طريق الفوز بدومين: .دخول_دومين`
        ...
        // 💰 كل لفل تطوير (من 1 إلى 15) يكلف 400,000 مال بالإضافة إلى التيونر
        const MONEY_COST_PER_LEVEL = 400000
