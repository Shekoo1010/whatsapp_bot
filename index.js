...
const commandExplanations = {
    ...
    'المتجر_والمعدات': {
        ...
        '.لبس': 'يلبس (يجهّز) قطعة معدات معينة على شخصية. مثال: .لبس رقم_الشخصية رقم_القطعة',
        '.خلع': 'يخلع قطعة معدات مجهّزة عن شخصية. مثال: .خلع سلاح رقم_الشخصية',
        '.معداتي': 'يعرض قطع المعدات المجهّزة على شخصياتك حالياً.',
        '.حقيبتي': 'يعرض حقيبة المعدات (Inventory) غير المجهّزة اللي تملكها.',
        '.بيع_معدة': 'يبيع قطعة معدات من حقيبتك برقمها. مثال: .بيع_معدة رقم',
        '.نعم_معدة': 'يؤكد بيع قطعة معدات معلّقة بعد أمر .بيع_معدة.',
        '.لا_معدة': 'يلغي عملية بيع قطعة معدات معلّقة.',
    ...
    'المطور': {
        ...
        '.اصلاح_المخزون': 'أمر للمطور فقط - يصلح بيانات مخزون/حقيبة المعدات التالفة.',
...
if (
    (text.startsWith('.equip') || text.startsWith('.لبس')) &&
    !text.startsWith('.equipment')
) {
