...
const commandExplanations = {
    ...
    'القتال': {
        ...
        '.قبول': 'يستخدم لأكثر من غرض حسب السياق: قبول دعوة انضمام لعشيرة، أو أي طلب معلّق آخر يحتاج موافقتك.',
        '.رفض': 'رفض دعوة انضمام لعشيرة أو طلب معلّق آخر.',
    },
    'الزعماء': {
    ...
    'العشائر_وحروبها': {
        '.العشائر': 'يعرض قائمة كل العشائر المسجّلة بالبوت مرتبة حسب القوة أو المستوى.',
        '.انشاء_عشيرة': 'ينشئ عشيرة جديدة باسم تحدده وتصبح قائدها. مثال: .انشاء_عشيرة الاسم',
        '.انضم': 'ينضم لعشيرة معينة برقمها من قائمة .العشائر. مثال: .انضم رقم_العشيرة',
        '.طرد': 'يطرد عضواً من عشيرتك (للقائد فقط) بالمنشن. مثال: .طرد @عضو',
        '.دعوة': 'يدعو لاعباً للانضمام لعشيرتك بالمنشن (للقائد/النائب). مثال: .دعوة @شخص',
        '.عشيرتي': 'يعرض معلومات عشيرتك الحالية (الأعضاء، القوة، المستوى).',
        '.خروج': 'يخرجك من عشيرتك الحالية.',
        '.شراء_عشيرة': 'يشتري ترقية أو غرضاً معيناً من متجر العشيرة برقمه. مثال: .شراء_عشيرة رقم',
        '.تبرع': 'يتبرع بمبلغ من مالك الخاص لخزينة عشيرتك. مثال: .تبرع 50000',
        '.متجر_العشيرة': 'يعرض متجر العشيرة والعناصر المتاحة للشراء بخزينة العشيرة.',
        '.حرب_عشيرة': 'يعلن حرب عشيرة رسمية ضد عشيرة أخرى بالمنشن على قائدها. مثال: .حرب_عشيرة @القائد',
        '.قبول_الحرب': 'يقبل إعلان حرب عشيرة معلّق ضد عشيرتك.',
        '.رفض_الحرب': 'يرفض إعلان حرب عشيرة معلّق ضد عشيرتك.',
    },
    'الحرب': {
