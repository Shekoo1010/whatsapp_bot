...
// مع احتمال التفاعل، بحسب المزاج — في المزاج المعكر لا تتفاعل غالباً
...
// 💬 تفاعل نامي (رياكشن) على رسالة المستخدم قبل الرد عليها، بحسب مزاجها
async function reactToNamiMessage(sock, msg, mood) {
    const config =
...
━━━━━━━━━━━━━━${viaUsername ? `\n\n💰 تم خصم ${USERNAME_ACTION_COST.toLocaleString()} مال (استخدام يوزرنيم)` : ''}`,
    ...
    await reactToNamiMessage(sock, msg, namiMood)
