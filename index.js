...
// 🔴 إغلاق القروب بعد مرور 10 دقائق من رأس الساعة
if (
minutes === 10 &&
global.bossAttackWindowOpen
) {

// 🔁 نفس منطق الفتح: محاولات متكررة عشان انقطاع مؤقت بالاتصال
// ما يخلي القروب يضل مفتوح لساعة كاملة بدون إغلاق
let closed = false
...
// ✅ تُعلَّم النافذة "مقفولة" فقط لو نجح الإغلاق فعلياً — نفس سبب
// تأخير التعليم بالفتح بالأعلى
