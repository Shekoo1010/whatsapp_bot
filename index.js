...
if (!text) return;
    ...
    // =========================
    // 🧠 QUIZ SYSTEM — يُفحص أولاً وفوراً، قبل بوابة الأوقات وقبل أي أمر آخر
    // عشان لو المسابقة شغالة بالقروب، كل الأوامر الثانية تتوقف
    // (ما عدا .انهاء_مسابقة و .النقاط) ويبقى فقط رد المسابقة شغال
    // لين تنتهي — بما فيها أوامر بدء مسابقة ثانية أو .اسحب أو .هجوم.
    // =========================
