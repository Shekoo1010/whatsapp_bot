...
sock.ev.on('messages.upsert', async ({ messages }) => {
    ...
    // صور بالكاش (تشمل هذي) ونبني الكولاج فوراً. ما فيه أي تخزين
    // دائم ولا كاش لصور عشوائية تُرسل بالقروب بدون علاقة بالأمر.
    // =========================
    if (msg.message.imageMessage && msg.key.remoteJid.endsWith('@g.us')) {
