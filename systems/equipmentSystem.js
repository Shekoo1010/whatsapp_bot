...
// =========================
// توليد مكافأة دومين (ندرة + نوع)
// نفس خط الإنتاج الموحّد المستخدم لصناديق المعدات تمامًا:
// يسحب القالب من equipments.js فقط عبر createEquipmentItem
// (نفس الستاتس العشوائية + نفس نظام الأفيكسات + نفس نظام الجودة/النجوم)
// =========================
