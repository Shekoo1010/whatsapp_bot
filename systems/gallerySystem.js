...
function resolveLiveCharacterData(owned) {
    ...
    return {
        ...
        // 🖼️ لو اللاعب استبدل صورة هذي النسخة بالضبط بأمر .استبدال،
        // نفضّلها دايمًا على صورة الكتالوج — نفس منطق applyCustomImage
        // بـ index.js، عشان .المعرض يعرض نفس الصورة المخصصة تلقائيًا.
        image: owned.customImage || latest.image,
        anime: latest.anime,
