...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .frame{max-width:1220px; margin:0 auto; position:relative;}
  ...
  .roster{display:flex; flex-wrap:wrap; justify-content:center; gap:16px; margin-bottom:16px;}
  .card{
    position:relative; width:190px; flex:0 0 190px; border-radius:10px; overflow:hidden; background:var(--bg2);
  ...
  .art{position:relative; flex:1; min-height:200px; background-size:cover; background-position:center top; background-color:#151a28;}
