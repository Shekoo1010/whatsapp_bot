...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .frame{max-width:2450px; margin:0 auto; position:relative;}
  ...
  .roster{display:flex; flex-wrap:wrap; justify-content:center; gap:28px; margin-bottom:26px;}
  .card{
    position:relative; width:375px; flex:0 0 375px; border-radius:15px; overflow:hidden; background:var(--bg2);
  ...
  .tier-tag{display:flex; align-items:center; justify-content:space-between; padding:13px 18px 7px;}
  ...
  .art{position:relative; flex:1; min-height:440px; background-size:cover; background-position:center top; background-color:#151a28;}
...
// ---------------------------------------------------------------
// ⚡ تحسين أداء: المتصفح صار مشترك ومحمي من التشغيل المتزامن — شوف
// utils/sharedBrowser.js (نفس خيارات التشغيل القديمة + تشغيل مفرد).
