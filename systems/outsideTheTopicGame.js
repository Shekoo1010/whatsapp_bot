...
const CATEGORY_WORDS = {
    'انمي': [
        'ناروتو','بوروتو','ون بيس','هجوم العمالقة','دراغون بول','دراغون بول زد','دراغون بول سوبر',
        'بليتش','ديث نوت','جوجوتسو كايسن','ديمون سلاير','فيري تيل','فول ميتال الكيميست','سلام دانك',
        'هانتر × هانتر','ون بانش مان','كود جياس','إيفانجيليون','نو غيم نو لايف','ري زيرو',
        'سورد آرت أونلاين','توكيو غول','بلاك كلوفر','سيفن ديدلي سينز','ذا برومس نيفرلاند',
        'هايكيو','كوروكو نو باسكيت','ماي هيرو أكاديميا','تشينسو مان','سباي × فاميلي',
        'جوجو مغامرة غريبة','دكتور ستون','أوفرلورد','المحقق كونان','ديجيمون','بوكيمون',
        'سيلور مون','دورايمون','كرايون شين تشان','جاري الجار توتورو','المخطوفة',
        'الأميرة مونونوكي','قلعة هاول المتحركة','خدمات كيكي للتوصيل','اسمك',
        'فاكهة السلة','بطاقات ساكورا السحرية','بلو لوك','أكيرا','كاوبوي بيبوب',
        'سول إيتر','إنويوشا','يوغي أوه'
    ],
    'رياضه': [
        ...
        'التجديف','الإبحار','تسلق الجبال','الغطس','الرماية','رمي الرمح','رمي القرص','القفز بالزانة',
        'الوثب الطويل','الوثب العالي','سباق الحواجز','سباق التتابع','الجمباز','الشطرنج',
        'المبارزة بالسيف','الرماية بالقوس','شد الحبل','التزلج على الجليد','التزلج على الثلج',
        'التزلج على الماء','ركوب الأمواج','الغوص الحر','الملاكمة التايلاندية','الدراجات الجبلية',
        'كرة القدم الأمريكية','الكرة الطائرة الشاطئية'
    ],
    'فواكه': [
        'تفاح','موز','عنب','بطيخ','مانجو','فراولة','أناناس','برتقال','رمان','كيوي','خوخ','كمثرى',
        'برقوق','كرز','مشمش','تين','تمر','جوافة','بابايا','فاكهة التنين','ليتشي','فاكهة العاطفة',
        'توت أزرق','توت العليق','جوز الهند','ليمون','ليمون أخضر','جريب فروت','يوسفي','كاكي',
        'سفرجل','زيتون','أفوكادو','تمر هندي','مانجوستين','رامبوتان','دوريان','كمكوات',
        'عنب أسود','عنب أخضر','شمام','قاوون','تين شوكي'
    ],
    'دول': [
    ...
    'اكلات': [
        'كبسة','مندي','مضغوط','برجر','بيتزا','شاورما','سوشي','مقلوبة','فول','كنافة','باستا','لازانيا',
        'فلافل','حمص','متبل','تبولة','كباب','شيش طاووق','مشاوي مشكلة','دجاج مشوي',
        'سمك مشوي','روبيان مقلي','معكرونة بالصلصة','بيتزا مارغريتا','بيتزا بيبروني','تاكو','بوريتو',
        'ناتشوز','كويساديا','سباغيتي بولونيز','فيتوتشيني ألفريدو','ريزوتو','باييا','رامن',
        'تيمبورا','ياكيتوري','دجاج كنتاكي','ناجتس','هوت دوغ','ساندويتش تونة','فطيرة سبانخ',
        'سمبوسة','معجنات جبن','خبز ثوم','سلطة سيزر','سلطة يونانية','ستيك لحم',
        'ستيك دجاج','برياني','كاري دجاج','كاري لحم','فاهيتا','انشيلادا',
        'شكشوكة','بيض بالطماطم','مسخن','ورق عنب','كبة','مقلوبة باذنجان','مسقعة','ملوخية','بامية',
        'مرق لحم','شوربة عدس','شوربة خضار','ريش لحم مشوي','همبرغر مزدوج','دونات','كيك شوكولاتة',
        'تشيز كيك','بان كيك','وافل','كريب','آيس كريم','بقلاوة','معمول','قطايف',
        'أم علي','رز باللبن','مهلبية','كنافة نابلسية','لقيمات','فتة حمص','فتة باذنجان',
        'حريرة مغربية','كسكسي','طاجين لحم','مندي دجاج','مظبي','جريش',
        'صيادية سمك','مشكل بحري','برياني هندي','دال هندي','تندوري تشيكن','نان بالثوم'
    ],
    'مسلسلات وافلام': [
    ...
    'شخصيات انمي او مسلسلات وافلام': [
        ...
        'جوكر','سوبرمان','كلارك كنت','واندر وومن','الرجل العنكبوت','بيتر باركر',
    ...
    'كرتون': [
        ...
        'السنافر','بينكي والعقل','ميكي ماوس','دونالد داك','توتلي سبايز','وينكس كلوب'
    ],
    'مشروبات': [
    ...
    'فواكه وخضار': [
        'تفاح','موز','عنب','بطيخ','مانجو','فراولة','أناناس','برتقال','رمان','كيوي',
        'خوخ','كمثرى','برقوق','كرز','مشمش','تين','تمر','جوافة','بابايا','ليمون',
        'جريب فروت','يوسفي','كاكي','سفرجل','جوز الهند','خس','طماطم','خيار','بصل',
        'ثوم','جزر','بطاطس','بطاطا حلوة','فلفل حلو','فلفل حار','باذنجان','كوسا',
        'قرنبيط','بروكلي','ملفوف','فجل','لفت','سبانخ','جرجير','بقدونس','كزبرة',
        'نعناع','بامية','فاصوليا خضراء','بازلاء','فول','ذرة','قرع','يقطين',
        'شمندر','كرفس','هليون','خرشوف','فطر','بصل أخضر','كراث','سلق',
        'عدس','حمص','فول سوداني','لوز','جوز','فستق','كاجو','بندق',
        'شمام','قاوون','فاكهة التنين','ليتشي','أفوكادو','زيتون'
    ],
    'الجاسوس': [
